...
def get_account_info(ContextInfo):
    ...
    for pos in position_details:
        g.position_details = {}
        symbol = pos.m_strInstrumentID + '.' + pos.m_strExchangeID  # 合约代码
        g.position_details['symbol'] = symbol  # 合约代码
        g.position_details['委托数量'] = pos.m_nVolumeTotalOriginal
        g.position_details['合同编号'] = pos.m_strOrderSysID
        g.position_details['订单编号'] = pos.m_nRef
        g.position_details['委托状态'] = pos.m_nOrderStatus
        g.position_details['EEntrustSubmitStatus'] = pos.m_nOrderSubmitStatus
        g.position_details['操作'] = pos.m_nDirection
        g.position_details['开平'] = pos.m_nOffsetFlag
        g.position_details['投保'] = pos.m_nHedgeFlag
        g.position_details['委托价格'] = pos.m_dLimitPrice

        g.position_details['内部委托号'] = pos.m_strOrderRef
        g.position_details['委托价格'] = pos.m_dLimitPrice
        g.position_details['委托日期'] = pos.m_strInsertDate
        g.position_details['委托时间'] = pos.m_strInsertTime
        g.position_details['成交金额'] = pos.m_dTradeAmount
        g.position_details['已成交量'] = pos.m_nVolumeTraded
        g.position_details['状态信息'] = pos.m_strErrorMsg
        g.position_details['EBrokerPriceType'] = pos.m_nOrderPriceType
